...
## <a name="pre-requisites"></a><span data-ttu-id="cff06-114">先决条件</span><span class="sxs-lookup"><span data-stu-id="cff06-114">Pre-requisites</span></span>
