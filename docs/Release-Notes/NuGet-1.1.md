...
* 切换到 OData 服务终结点从 ATOM 馈送的包： 如果你升级到 CTP2 版本的 NuGet，请务必为程序包源中添加下面的 URL: [http://go.microsoft.com/fwlink/?LinkID=204820](http://go.microsoft.com/fwlink/?LinkID=204820)。
* 重命名为添加程序包命令*安装包*。
