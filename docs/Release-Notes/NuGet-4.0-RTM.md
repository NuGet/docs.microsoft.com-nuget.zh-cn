...
---
# <a name="40-rtm-release-notes"></a>4.0 RTM 发行说明
...
* Dotnet Restore foo.sln - SLN 中的配置导致还原图中出现重复（但配置不同）项目时，此操作失败 - [#4316](https://github.com/NuGet/Home/issues/4316)
...
* 包的运行过于频繁 - 目标依赖项关系图中存在涉及目标“包”的循环依赖时，dotnet 包失败 - [#4381](https://github.com/NuGet/Home/issues/4381)
...
* dotnet 包不支持 `.csproj` 中的标题 - [#4150](https://github.com/NuGet/Home/issues/4150)
...
* dotnet 包 - ProjectReference 丢失版本信息 - [#3953](https://github.com/NuGet/Home/issues/3953)
...
* dotnet 包应使用生成包时所用的版本来打包工具 - [#4063](https://github.com/NuGet/Home/issues/4063)
...
* PackagePath 为空时，dotnet 包失败 - [#3993](https://github.com/NuGet/Home/issues/3993)
...
* dotnet pack3 执行额外标记拆分操作 - [#3701](https://github.com/NuGet/Home/issues/3701)

* dotnet 包：打包具有包引用的项目导致重复导入警告 - [#3665](https://github.com/NuGet/Home/issues/3665)
...
* dotnet 包从 obj（而不是 bin）进行打包 - [#3880](https://github.com/NuGet/Home/issues/3880)

* dotnet 包似乎始终将 ProjectReference 版本设置为 1.0.0 - [#3874](https://github.com/NuGet/Home/issues/3874)

* 由于项目引用和 <TargetFramework>，dotnet 包失败 - [#3865](https://github.com/NuGet/Home/issues/3865)
...
[问题列表 1](https://github.com/NuGet/Home/issues?q=is%3Aissue+is%3Aclosed+milestone%3A%224.0 RTM")  
[问题列表 2](https://github.com/NuGet/Home/issues?q=is%3Aissue+is%3Aclosed+milestone%3A%224.0 RC4")  
[问题列表 3](https://github.com/NuGet/Home/issues?q=is%3Aissue+is%3Aclosed+milestone%3A%224.0 RC3")  
[问题列表 4](https://github.com/NuGet/Home/issues?q=is%3Aissue+is%3Aclosed+milestone%3A%224.0 RC2")  
[问题列表 5](https://github.com/NuGet/Home/issues?q=is%3Aissue+is%3Aclosed+milestone%3A%224.0 RC")
