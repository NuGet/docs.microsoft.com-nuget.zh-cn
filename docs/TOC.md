...
## [程序包管理器控制台](tools/package-manager-console.md)
...
## [项目文件中的包参考](consume-packages/package-references-in-project-files.md)
...
### [用于 Visual Studio 的 NuGet 凭据提供程序](reference/extensibility/nuget-credential-providers-for-visual-studio.md)
...
### [project.json 影响](archive/project-json-impact.md)
# API
## [概述](api/overview.md)
## 资源
...
### [NuGet 3.0 预览版](release-notes/NuGet-3.0-Preview.md)
## NuGet 2.x
