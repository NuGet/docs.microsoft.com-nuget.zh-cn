...
- dotnet
  - dotnetcore 添加包可从 csproj 清除空行 - [#5697](https://github.com/NuGet/Home/issues/5697)
...
- dotnet
  - 根据 TargetFramework 与 TargetFrameworks，dotnetcore pack 的行为有所不同 - [#5281](https://github.com/NuGet/Home/issues/5281)
