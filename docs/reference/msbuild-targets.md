...
| LicenseUrl | PackageLicenseUrl | 空 | `licenseUrl`正在弃用, 请使用 PackageLicenseExpression 或 PackageLicenseFile 属性 |
...
作为[NuGet 问题 352](https://github.com/NuGet/Home/issues/352)的一部分更改, `PackageIconUrl`最终将更改为`PackageIconUri` , 并且可以是图标文件的相对路径, 该文件将包含在生成的包的根目录中。
