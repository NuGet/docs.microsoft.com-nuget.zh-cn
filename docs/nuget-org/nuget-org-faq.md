...
1. **要求**：首选需要在 nuget.org 上创建一个用作组织帐户管理员的个人帐户。 如果没有此帐户，请[新建一个 nuget.org 帐户](individual-accounts.md)
...
如果想要将帐户转换为组织，请遵循[将我的 nuget.org 帐户转换为组织](#how-to-transform-my-nugetorg-account-to-an-organization)中给出的步骤进行操作。
